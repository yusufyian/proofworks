...
const navigation = [
  ...
  { name: '组织碳盘查', href: '/inventory', icon: FileText },
  { name: '产品碳足迹', href: '/product', icon: Leaf },
  { name: '减排项目', href: '/reduction', icon: TrendingDown },
  { name: 'ESG报告', href: '/esg', icon: Award },
        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between h-20 px-6 border-b border-gray-200 bg-gradient-to-r from-primary-600 to-primary-700">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-xl font-bold text-white block">碳足迹ESG</span>
                <span className="text-xs text-primary-100">Carbon & ESG</span>
              </div>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
