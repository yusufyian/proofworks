...
const navigation = [
  ...
  { name: '对账管理', href: '/reconciliation', icon: FileCheck },
  { name: '差异处理', href: '/discrepancy', icon: AlertTriangle },
  { name: '清分管理', href: '/settlement', icon: DollarSign },
];
        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between h-20 px-6 border-b border-gray-200 bg-gradient-to-r from-primary-600 to-primary-700">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-xl font-bold text-white block">结算对账平台</span>
                <span className="text-xs text-primary-100">Reconciliation Platform</span>
              </div>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
