...
export function ApplicationCard({ application }: ApplicationCardProps) {
  return (
    <div className="group relative">
      <motion.div
        whileHover={{ y: -4 }}
        className="glass rounded-2xl p-8 h-full flex flex-col relative overflow-visible border border-white/10 hover:border-white/20 transition-all duration-300"
      >
        ...
        <Link to={`/app/${application.id}`} className="flex-1 flex flex-col">
          <div className="relative z-10 flex-1 flex flex-col">
            ...
            <h3 className="text-2xl font-bold mb-3">{application.shortName}</h3>
            <p className="text-gray-300 mb-6 leading-relaxed">{application.tagline}</p>
            ...
            {/* Industries */}
            <div className="mt-auto pt-6 border-t border-white/10 mb-4">
              <p className="text-xs text-gray-400 mb-3 uppercase tracking-wider">适用行业</p>
