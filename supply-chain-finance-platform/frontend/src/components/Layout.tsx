...
const navigation = [
  ...
  { name: '凭证管理', href: '/certificates', icon: FileText },
  { name: '转让记录', href: '/transfers', icon: ArrowLeftRight },
  { name: '融资管理', href: '/financing', icon: CreditCard },
];
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-20 px-6 border-b border-gray-200 bg-gradient-to-r from-primary-600 to-primary-700">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-xl font-bold text-white block">供应链金融</span>
                <span className="text-xs text-primary-100">Supply Chain Finance</span>
              </div>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
